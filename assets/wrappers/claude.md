# Claude Strict Wrapper

Load the `adonisjs-7-deterministic` skill in `fail-closed` mode and keep the wrapper short.
...
- Wait for explicit one-off confirmation before implementing the divergent path.
